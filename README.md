...
This program determines the galvanic electricy reading from a sensor and displays the value on a micro:bit. 
When the "A" button is pressed, it activates the sensor, displays the value, and deactivates the sensor.
